...
public class DeleteLead extends BaseClass {
	...
	public void deleteLead() throws InterruptedException {
		...
		countryCode.clear();
		countryCode.sendKeys("121");
		
		driver.findElement(By.xpath("//input[contains(@name,'phoneAreaCode')]")).sendKeys("022");
		
		driver.findElement(By.xpath("//input[contains(@name,'phoneNumber')]")).sendKeys("1234567890");
